'''
write a python program to remove all duplicate elements from a sorted linked list
containing integerdata.
use the linked list class and methods in it to implement the above program.
example:
